                    ...
                    <div class="grid grid-cols-12">
                        <div
                            ...
                            <div class="flex items-center justify-between pb-8 border-b border-gray-300">
                                <h2 class="font-manrope font-bold text-3xl leading-10 text-black">Bag</h2>
                            ...
                            <div
                                ...
                                <div class="w-full md:max-w-[126px]">
                                    <img src="https://tailwindui.com/img/ecommerce-images/product-page-01-related-product-01.jpg" alt="perfume bottle image"
                                        class="mx-auto" />
                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-4 w-full">
                                    <div class="md:col-span-2">
                                        <div class="flex flex-col max-[500px]:items-center gap-3">
                                            <h6 class="font-semibold text-base leading-7 text-black">Basic Tee</h6>
                                            <h6 class="font-normal text-base leading-7 text-gray-500">Black</h6>
                                            <h6 class="font-semibold text-base leading-7 text-indigo-600">$35.00</h6>
                                            <a class="font-normal text-base leading-7 text-red-500">Remove</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center max-[500px]:justify-center md:justify-end max-md:mt-3 h-full">
                                        <p class="font-bold text-lg leading-8 text-indigo-600 text-center">$35</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div class="mt-8">
                                <div class="flex items-center justify-between pb-6">
                                    ...
                                    <p class="font-medium text-lg leading-8 text-black">$35</p>
                                </div>
                                <form>
                                    ...
                                    <div class="flex items-center border-b border-gray-200">
                                        <button
                                            class="rounded-full w-full bg-black py-3 px-4 text-white text-sm font-semibold text-center mb-8 transition-all duration-500 hover:bg-black/80">Checkout</button>
                                    </div>
